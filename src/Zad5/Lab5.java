...
public class Lab5 extends GLJPanel implements GLEventListener, KeyListener{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2106312717891956038L;
	...
	private String currentColor = "zielony"; // Domyślny kolor - zielony                    //   (Controlled by number keys.)
	...
	private void piramida(float size, float n, GL2 gl2) {
	    ...
	    if (currentColor.equals("zielony")) {
	        gl2.glColor3f(0, 1, 0); // Zielony kolor
	    } else if (currentColor.equals("brązowy")) {
	        gl2.glColor3f(0.6f, 0.4f, 0.2f); // Brązowy kolor
	    } else if (currentColor.equals("niebieski")) {
	        gl2.glColor3f(0, 0, 1); // Niebieski kolor
	    } else {
	...
	public void keyPressed(KeyEvent evt) {
		...
		if ( key == KeyEvent.VK_LEFT )
		    ...
		    if (currentColor.equals("zielony"))
		        currentColor = "brązowy";
		    else if (currentColor.equals("brązowy"))
		        currentColor = "niebieski";
		    else if (currentColor.equals("niebieski"))
		        currentColor = "zielony";
		}
		else
			repaint = false;
		if (repaint)
