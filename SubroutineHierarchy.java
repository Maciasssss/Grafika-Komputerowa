...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		hexagon(g2, 100, -1.02, -0.05);
		hexagon(g2, 100, 1.04, -0.98);
		hexagon(g2, 80, -1.379, 1.40);
		hexagon(g2, 80, -3.13, 2.23);
		hexagon(g2, 60, 0.9, 2.05);
		hexagon(g2, 60, 2.12, 1.45);
	...
	private void hexagon(Graphics2D g2,double r, double translate_x ,double translate_y) // polygon
	{
		AffineTransform saveTransform = g2.getTransform();
