...
public class SceneGraph extends JPanel {
	...
	private TransformedObject T1;
	private TransformedObject T2;
	private TransformedObject T3;
	private TransformedObject L1;
	private TransformedObject L2;
	private TransformedObject L3;
	private TransformedObject H1;
	private TransformedObject H2;
	private TransformedObject H3;
	private TransformedObject H4;
	private TransformedObject H5;
	private TransformedObject H6;
	...
	private void createWorld() {
		...
		T2.setScale(0.5,1).setTranslation(-2.25,0.5).setColor(Color.PINK);
		world.add(T2);
		...
		H1 = new TransformedObject(hexagon);
		H1.setScale(0.3,0.3).setTranslation(-0.889,-0.42);
		world.add(H1);

		H2 = new TransformedObject(hexagon);
		H2.setScale(0.3,0.3).setTranslation(0.889,-1.189);
		world.add(H2);

		H3 = new TransformedObject(hexagon);
		H3.setScale(0.25,0.25).setTranslation(-3,1.825);
		world.add(H3);

		H4 = new TransformedObject(hexagon);
		H4.setScale(0.25,0.25).setTranslation(-1.4,1.18);
		world.add(H4);

		H5 = new TransformedObject(hexagon);
		H5.setScale(0.2,0.2).setTranslation(0.83,2.07);
		world.add(H5);

		H6 = new TransformedObject(hexagon);
