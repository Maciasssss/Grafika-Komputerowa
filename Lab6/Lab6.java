...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {
        ...
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, blue1, 0);
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, blue2, 0);
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, blue3, 0);
        gl2.glMaterialf(GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, 32);
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        float[] newPosition = {1, 1, 1, 0};  // New position of the light source
        gl2.glLightfv(GL2.GL_LIGHT1, GLLightingFunc.GL_POSITION, newPosition, 0);
